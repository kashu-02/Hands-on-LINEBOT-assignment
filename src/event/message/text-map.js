...
export const messageMap = {
  ...
  ニュース: async () => {
    const { articles } = (await get(`https://newsapi.org/v2/top-headlines?country=jp&apiKey=${process.env.NEWS_API_KEY}&pageSize=5`)).data;
    let message = '';
    articles.forEach((element) => {
      message += `【画像URL】${element.urlToImage} \n\n 【タイトル】${element.title} \n\n 【概要】${element.description} \n\n 【公開日】${element.publishedAt} \n\n 【掲載元】${element.source.name} \n\n\n\n\n`;
    });
    return {
      type: 'text',
      text: message,
